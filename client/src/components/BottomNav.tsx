...
const BottomNav = () => {
  ...
  const navItems = [
    { path: '/home', id: 'home', icon: '🏠', label: 'Home' },
    { path: '/matches', id: 'matches', icon: '💬', label: 'Matches' },
    { path: '/criteria', id: 'criteria', icon: '⚙️', label: 'Filters' },
    { path: '/profile', id: 'profile', icon: '👤', label: 'Profile' },
  ];

  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 h-16 z-30">
